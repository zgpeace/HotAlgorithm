...
- [* 3] [不同的子序列（困难）](https://leetcode.com/problems/distinct-subsequences/)
- [* 2] [柱状图中最大的矩形（困难）](https://leetcode.com/problems/largest-rectangle-in-histogram/)
- [* 1] [最大矩形（困难）](https://leetcode.com/problems/maximal-rectangle/)
